...
// error: import frc.robot.subsystems.DriveTrain;
// error: import frc.robot.subsystems.ExampleSubsystem;
...
public class Robot extends TimedRobot {
  // error: public static ExampleSubsystem m_subsystem = new ExampleSubsystem();
